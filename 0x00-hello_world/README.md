This folder contains introductory C scripts. This project is the first C project as part of the ALX curriculum, and covers the very basics of compilation and C.
